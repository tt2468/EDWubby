...
module.exports = new Plugin({
    ...
    load: async function() {
        ...
        let gg = findModule('getGuild'), gc = findModule('getChannels'), gu = findModule('getCurrentUser'), cp = findModule('computePermissions'), lg = findModule('getLastSelectedGuildId'), gsc = findModule('getChannel');
